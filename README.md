...
This is a hobby project, with a focus on small, fast and fun code. It deliberately doesn't have dependencies or third party frameworks, to keep the code tiny and efficient. 
